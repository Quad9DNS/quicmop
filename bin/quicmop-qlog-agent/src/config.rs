...
pub struct AgentConfig {
    ...
    #[serde(default = "default_qlog_dir")]
...
fn default_metrics_prefix() -> String {
    "quicmop_qlog_agent".to_string()
}

fn default_qlog_dir() -> PathBuf {
    "/var/lib/quicmop/quicmop-qlog-agent".into()
}
...
impl TryFrom<CliArgs> for ServiceConfig {
    ...
    fn try_from(value: CliArgs) -> crate::Result<ServiceConfig> {
        ...
        if value.qlog_dir != default_qlog_dir() {
            agent_config.qlog_dir = value.qlog_dir;
        }
